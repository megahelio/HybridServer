...
public class XMLController implements GenericController {
    ...
    public XMLController(DaoXML daoXML, DaoXSLT daoXSLT, DaoXSD daoXSD, List<ServerConfiguration> servers) {
        this.daoXML = daoXML;
    ...
    public HTTPResponse list(HTTPRequest request) {
        ...
        fullList = fullList.concat(this.daoXML.listPages());
        ...
        for (ServerConfiguration server : this.servers) {
            ...
            if (!server.getName().equals("Down Server")) {
                ...
                try {
                    ...
                    fullList = fullList.concat(ws.listPagesXML());
                } catch (MalformedURLException e) {
